...
class LocalWaypointData {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new LocalWaypointData(null);
  ...
  static datatype() {
    ...
    return 'autoku_msgs/LocalWaypointData';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return 'f152e1e888768e9d62f27b1539b9e86d';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LocalWaypointData(null);
...
module.exports = LocalWaypointData;
